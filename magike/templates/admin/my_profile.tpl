	...
	<div class="input">
		...
		<p>
			<select name="user_group">
				<option value="administrator" <[if:$insert_user.user_group == "administrator"]>selected=true<[/if]>>{lang.group.administrator}</option>
				<option value="editor" <[if:$insert_user.user_group == "editor"]>selected=true<[/if]>>{lang.group.editor}</option>
				<option value="contributor" <[if:$insert_user.user_group == "contributor"]>selected=true<[/if]>>{lang.group.contributor}</option>
				<option value="visitor" <[if:$insert_user.user_group == "visitor"]>selected=true<[/if]>>{lang.group.visitor}</option>
			</select><br />
