...
<div id="content">
	...
	<[/if]>
		...
		<div id="search"><form method="get"><strong>关键字:</strong> <input type="text" size=20 name="keywords" /> <input type="checkbox" name="type" value="tags" />按标题
		 <input type="checkbox" name="type" value="tags" />按标签 <input type="checkbox" name="type" value="tags" />按内容 <input type="checkbox" name="type" value="tags" />按分类 <input type="submit" value="搜索" /></form></div>
