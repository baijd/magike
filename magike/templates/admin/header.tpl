...
<img src="{$static_var.siteurl}/templates/{$static_var.admin_template}/images/user.gif" alt="user" />欢迎回来 <a href="{$static_var.index}/admin/users/user/?user_id={$access.user_id}">{$access.user_name}</a> | <a href="#">登出</a>
</span>
