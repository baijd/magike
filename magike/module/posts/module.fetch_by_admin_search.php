 ...
 * File Name : module.fetch_by_admin_search.php
 * Copyright : Magike Group
 * License   : GNU General Public License 2.0
 *********************************/
 
class FetchByAdminSearch extends Posts
{
	private $result;
	...
	public function outputPosts()
	{
		...
		{
			$this->result = $this->model->fetchPostsByKeywordsAndAuthor($keywords,$this->getArgs['limit'],$this->stack['access']['user_id'],$this->offset,array('function' => array($this,'prasePost')),$this->getArgs['supper']);
		}
	}
