 ...
 * File Name : module.fectch_by_category.php
 * Copyright : Magike Group
 * License   : GNU General Public License 2.0
 *********************************/
 
class FectchByCategory extends Posts
{
	private $result;
	...
	public function outputPosts()
	{
		...
		$this->result = $this->model->fectchPostsByCategory($_GET['category_postname'],$this->getArgs['limit'],$this->offset,array('function' => array($this,'prasePost')));
	}
