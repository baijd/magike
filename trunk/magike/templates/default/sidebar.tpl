...
<div id="sidebar">
	...
	<ul>
		...
		<form method="get" style="margin:0;padding:0" action="{$static_var.index}/search/">
			<input type="text" name="keywords" size="30" value="Please enter keywords here ..." onfocus="this.setAttribute('value','');" style="margin-top:4px;font-family:verdana, Helvetica, sans-serif;height:16px;font-size:9pt;border:none;padding:0 5px;color:#AAA;background:#EEF0F2" />
		</form>
		</li>
	</ul>
	<h2>Category</h2>
