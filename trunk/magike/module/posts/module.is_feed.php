 ...
 * File Name : module.is_feed.php
 * Copyright : Magike Group
 * License   : GNU General Public License 2.0
 *********************************/
 
 class IsFeed extends Posts
 {	
	public function runModule($args)
	{
		...
		return $this->model->listAllFeedEntries($this->getArgs['limit'],$this->offset,array('function' => array($this,'prasePost')));
	}
 }
?>
