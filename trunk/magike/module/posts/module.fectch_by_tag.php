 ...
 *********************************/
 ...
 class FectchByTag extends Posts
 {
 	private $result;
	...
	public function outputPosts()
	{
		...
		$this->result = $this->model->fectchPostsByTag($_GET['tag_name'],$this->getArgs['limit'],$this->offset,array('function' => array($this,'prasePost')));
	}
